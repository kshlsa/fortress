...
func init() {
	proto.RegisterType((*QueryDevFeeInfosRequest)(nil), "fortress.fees.v1.QueryDevFeeInfosRequest")
	proto.RegisterType((*QueryDevFeeInfosResponse)(nil), "fortress.fees.v1.QueryDevFeeInfosResponse")
	proto.RegisterType((*QueryDevFeeInfoRequest)(nil), "fortress.fees.v1.QueryDevFeeInfoRequest")
	proto.RegisterType((*QueryDevFeeInfoResponse)(nil), "fortress.fees.v1.QueryDevFeeInfoResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "fortress.fees.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "fortress.fees.v1.QueryParamsResponse")
	proto.RegisterType((*QueryDevFeeInfosPerDeployerRequest)(nil), "fortress.fees.v1.QueryDevFeeInfosPerDeployerRequest")
	proto.RegisterType((*QueryDevFeeInfosPerDeployerResponse)(nil), "fortress.fees.v1.QueryDevFeeInfosPerDeployerResponse")
}

func init() { proto.RegisterFile("fortress/fees/v1/query.proto", fileDescriptor_6533658f63002c05) }
...
func (c *queryClient) DevFeeInfos(ctx context.Context, in *QueryDevFeeInfosRequest, opts ...grpc.CallOption) (*QueryDevFeeInfosResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fortress.fees.v1.Query/DevFeeInfos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DevFeeInfo(ctx context.Context, in *QueryDevFeeInfoRequest, opts ...grpc.CallOption) (*QueryDevFeeInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fortress.fees.v1.Query/DevFeeInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fortress.fees.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) DevFeeInfosPerDeployer(ctx context.Context, in *QueryDevFeeInfosPerDeployerRequest, opts ...grpc.CallOption) (*QueryDevFeeInfosPerDeployerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fortress.fees.v1.Query/DevFeeInfosPerDeployer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_DevFeeInfos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fortress.fees.v1.Query/DevFeeInfos",
	}
...
func _Query_DevFeeInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fortress.fees.v1.Query/DevFeeInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fortress.fees.v1.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_DevFeeInfosPerDeployer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fortress.fees.v1.Query/DevFeeInfosPerDeployer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "fortress.fees.v1.Query",
	...
	Metadata: "fortress/fees/v1/query.proto",
}
