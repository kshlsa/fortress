...
// source: fortress/vesting/v1/vesting.proto
...
func init() {
	proto.RegisterType((*ClawbackVestingAccount)(nil), "fortress.vesting.v1.ClawbackVestingAccount")
}

func init() { proto.RegisterFile("fortress/vesting/v1/vesting.proto", fileDescriptor_5f1a3c86c0cebe5f) }
