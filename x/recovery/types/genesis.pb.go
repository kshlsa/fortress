...
// source: fortress/recovery/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "fortress.recovery.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "fortress.recovery.v1.Params")
}

func init() { proto.RegisterFile("fortress/recovery/v1/genesis.proto", fileDescriptor_8a3e70cb61e26f25) }
