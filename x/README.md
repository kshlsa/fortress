...
Here are some production-grade modules that can be used in Torque applications, along with their respective documentation:
...
- [erc20](erc20/spec/README.md) - Trustless, on-chain bidirectional internal conversion of tokens between Torque' EVM and Cosmos runtimes.
