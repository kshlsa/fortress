...
// source: torque/claims/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "torque.claims.migrations.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "torque.claims.migrations.v1.Params")
}

func init() { proto.RegisterFile("torque/claims/v1/genesis.proto", fileDescriptor_f2f8f1d6f18af278) }
