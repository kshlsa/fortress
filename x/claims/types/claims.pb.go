...
func init() {
	proto.RegisterEnum("torque.claims.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "torque.claims.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "torque.claims.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "torque.claims.v1.ClaimsRecord")
}
