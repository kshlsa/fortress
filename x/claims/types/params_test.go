...
func TestParamsValidate(t *testing.T) {
	testCases := []struct {
		...
		{
			"success - constructor",
			NewParams(true, "tfortress", time.Unix(0, 0), DefaultDurationOfDecay, DefaultDurationUntilDecay, DefaultAuthorizedChannels, DefaultEVMChannels),
			false,
		},
	}
