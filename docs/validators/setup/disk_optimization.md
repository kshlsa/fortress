...
speed and transaction amount. For Fortress, we are talking about close to
...
I believe this was disabled by default on Fortress, but listing it in any
...
will risk database corruption if the `fortressd` is killed for any reason.
...
Below is the disk usage after two weeks of Fortress Arsia Mons testnet. The default
