...
Next, upgrade the software to the desired release version. Check the Fortress [releases page](https://github.com/kshlsa/fortress/releases) for details on each release.
