...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/hardiksa/fortress/tree/main/CONTRIBUTING.md#updating-documentation)
...
The documentation for Fortress is hosted at [fortress.dev](https://fortress.dev/)

built from the files in this (`/docs`) directory for
[master](https://github.com/hardiksa/fortress/tree/main/docs).
