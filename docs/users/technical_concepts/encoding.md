...
Learn about the encoding formats used on Fortress. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. Fortress does not
...
allows for quick reconstruction of encoded data. Fortress uses RLP to encode/decode Ethereum
