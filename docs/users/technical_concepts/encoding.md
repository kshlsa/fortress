...
Learn about the encoding formats used on Torque. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. Torque does not
...
allows for quick reconstruction of encoded data. Torque uses RLP to encode/decode Ethereum
