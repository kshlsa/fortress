...
preparing test network with chain-id "fortress_1276974-1"
...
```bash
fortressd keys add test --recover
```

Check the balance of the account address:

```bash
fortressd q bank balances [address]
```
