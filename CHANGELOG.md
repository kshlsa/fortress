...
- (ci) [\#136](https://github.com/hardiksa/torque/pull/136) Deploy `torque` docker container to [docker hub](https://hub.docker.com/u/hardiksa) for every versioned releases
